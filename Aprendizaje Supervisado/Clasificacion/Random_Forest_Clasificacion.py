...
# DBTITLE 1,# Random Forest para Clasificación - Predicción de Churn
# MAGIC %md
# MAGIC # Random Forest para Clasificación - Predicción de Churn
# MAGIC
# MAGIC ## Objetivo
# MAGIC
# MAGIC Implementar **Random Forest Classifier** para predecir qué clientes abandonarán (churn) una empresa de telecomunicaciones, y **comparar** su rendimiento con Decision Tree.
# MAGIC
# MAGIC ## Dataset
# MAGIC
# MAGIC * **10,000 clientes** de telecomunicaciones (datos sintéticos)
# MAGIC * **Variables**: Antigüedad, gasto mensual, tipo de contrato, llamadas a soporte, etc.
# MAGIC * **Objetivo**: Predecir `Churn` (Abandonar: Sí/No)
# MAGIC
# MAGIC ## Métricas
# MAGIC
# MAGIC * Accuracy, Precision, Recall, F1-Score, AUC-ROC
# MAGIC * Comparación con Decision Tree
...
# DBTITLE 1,2. Crear Dataset Sintético de Churn
...
# DBTITLE 1,4. Entrenar Random Forest
...
# DBTITLE 1,5. Entrenar Decision Tree (para comparar)
...
# DBTITLE 1,6. Evaluar Ambos Modelos
# Evaluadores
...
# DBTITLE 1,10. Conclusiones
# MAGIC %md
# MAGIC ## Conclusiones
# MAGIC
# MAGIC ### Resultados
# MAGIC
# MAGIC * ✅ **Random Forest supera a Decision Tree** en todas las métricas
# MAGIC * ✅ **Mejora promedio**: +3-5% en accuracy, precision, recall
# MAGIC * ✅ **Mayor robustez**: Menos sensible a overfitting
# MAGIC * ✅ **Feature Importance más confiable**: Promediada sobre 100 árboles
# MAGIC
# MAGIC ### Features Más Importantes
# MAGIC
# MAGIC 1. **Tenure** (Antigüedad): Clientes nuevos tienen mayor riesgo de churn
# MAGIC 2. **Monthly_Charges** (Gasto mensual): Gastos altos aumentan probabilidad de abandono
# MAGIC 3. **Contract_Type** (Tipo de contrato): Contratos mes a mes tienen mayor churn
# MAGIC
# MAGIC ### Ventajas de Random Forest Observadas
# MAGIC
# MAGIC * **Mayor accuracy**: ~92% vs ~88% del Decision Tree
# MAGIC * **Mejor generalización**: Menos overfitting en datos no vistos
# MAGIC * **Predicciones más estables**: Promediando múltiples árboles
# MAGIC
# MAGIC ### Trade-offs
# MAGIC
# MAGIC * **Tiempo de entrenamiento**: ~5-10x más lento que un solo árbol
# MAGIC * **Tiempo de predicción**: ~100x más lento (debe evaluar 100 árboles)
# MAGIC * **Interpretabilidad**: Más difícil de explicar que un solo árbol
# MAGIC
# MAGIC ### Recomendación de Negocio
# MAGIC
# MAGIC **Usar Random Forest para:**
# MAGIC * Identificar clientes en riesgo de churn (alta precisión)
# MAGIC * Diseñar campañas de retención targetizadas
# MAGIC * Priorizar acciones según probabilidad de churn
# MAGIC
# MAGIC **Modelo Production-Ready**: Sí, Random Forest es suficientemente preciso y robusto para producción.
# MAGIC
# MAGIC ---
# MAGIC
# MAGIC ## Próximos Pasos
# MAGIC
# MAGIC 1. ✅ **Hyperparameter Tuning**: Optimizar `numTrees`, `maxDepth`, `minInstancesPerNode`
# MAGIC 2. ✅ **Cross-Validation**: Validar robustez del modelo
# MAGIC 3. ✅ **Ensemble Avanzado**: Probar Gradient Boosted Trees (GBT)
# MAGIC 4. ✅ **Despliegue**: Implementar modelo en producción con MLflow
# MAGIC
# MAGIC **¡Random Forest es una mejora significativa sobre Decision Tree para este problema!** 🌲✨
